...
Diese Datei enthält die Einstellungsseite für den CV2Profile Konverter als Teil der 
...
st.set_page_config(page_title="Einstellungen - CV2Profile", layout="wide")
...
# CSS für das gleiche Design wie in der Hauptanwendung
custom_css = """
<style>
