...
with col1:
    ...
    st.markdown(f'<div style="text-align: center;"><div style="display: inline-block; border-radius: 50%; width: 45px; height: 45px; line-height: 45px; font-weight: bold; font-size: 18px; {step1_style}">1</div><p style="color: white; margin-top: 10px; font-weight: {500 if st.session_state.step == 1 else 400};">Analyse & Extraktion</p></div>', unsafe_allow_html=True)
with col2:
    ...
    st.markdown(f'<div style="text-align: center;"><div style="display: inline-block; border-radius: 50%; width: 45px; height: 45px; line-height: 45px; font-weight: bold; font-size: 18px; {step2_style}">2</div><p style="color: white; margin-top: 10px; font-weight: {500 if st.session_state.step == 2 else 400};">Profil erstellen</p></div>', unsafe_allow_html=True)
...
if st.session_state.step == 1:
    ...
    # Fester Standard-Verarbeitungsmodus ohne Auswahlmöglichkeit
